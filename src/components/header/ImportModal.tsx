...
import { RiAddCircleLine, RiLinkM, RiLoader4Line, RiDownload2Line, RiMusicLine } from 'react-icons/ri';
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50" onClick={onClose}>
            ...
            >
                <h2 className="text-xl font-bold mb-6 text-white flex items-center gap-2">
                    <RiAddCircleLine className="text-primary" />
                    Import Audio
                </h2>
                    ...
                    <div className="flex gap-2 mb-3">
                        <div className="relative flex-1">
                            <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
                                <RiLinkM className="text-gray-500 text-lg" />
                            </div>
                            <input
                                type="text"
                                value={youtubeUrl}
                ...
                <div className="mb-6">
                    ...
                    >
                        <div className="p-2 bg-background-dark group-hover:bg-primary group-hover:text-black rounded-full transition-colors text-gray-400 shadow-ui-element-inset">
                            <RiMusicLine className="text-xl block" />
                        </div>
